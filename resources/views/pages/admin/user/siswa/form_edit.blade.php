                ...
                <div class="col-sm-12 col-md-4 offset-md-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.user.siswa.update', $lists->id) }}" method="POST">
                                @csrf
                                @method('patch')
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nisn" name="nisn"
                                        value="{{ old('nisn') ?? $lists->nisn }}" required />
                                </div>
                                <div class="mb-3">
                                    <label for="kelas">Kelas</label>
                                    <select class="form-control" id="kelas" name="kelas" required>
                                        <option @selected($lists->kelas == 7) value="7">7</option>
                                        <option @selected($lists->kelas == 8) value="8">8</option>
                                        <option @selected($lists->kelas == 9) value="9">9</option>
                                    </select>
                                </div>
                                <div class="mb-3">
