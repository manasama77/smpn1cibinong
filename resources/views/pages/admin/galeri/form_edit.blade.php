                ...
                <div class="col-sm-12 col-md-6 offset-md-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.galeri.update', $lists->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="text-muted">Kosongkan jika foto tidak ada perubahan</div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="description" name="description" required>{{ $lists->description }}</textarea>
                                </div>
